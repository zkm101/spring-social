...
public class FacebookFilter implements Filter {
	...
	private final static Log log = LogFactory.getLog(FacebookFilter.class);
	...
	public void doFilter(
		...
		FacebookHttpServletRequest fbRequest = 
			new FacebookHttpServletRequest( (HttpServletRequest) request );
